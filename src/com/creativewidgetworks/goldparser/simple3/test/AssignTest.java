...
import com.creativewidgetworks.goldparser.simple3.rulehandlers.Assign;
...
public class AssignTest extends GOLDParserTestCase {
    ...
    public void testAssign_parameters() throws Exception {
        ...
        try {
            ...
            assertEquals("wrong msg", "Wrong number of parameters, expected 3 but got 5.", pe.getMessage());
        }
