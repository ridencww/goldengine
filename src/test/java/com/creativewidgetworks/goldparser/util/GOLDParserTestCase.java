...
public abstract class GOLDParserTestCase extends TestCase {
    ...
    public static final String GRAMMAR  = "src/test/resources/simple2/Simple2.cgt";
    public static final String HANDLERS = "com.creativewidgetworks.goldparser.simple2.rulehandlers";
