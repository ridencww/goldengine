...
public class ParserTest extends TestCase {
    ...
    public void testLoadTables_File_CGT() throws Exception {
        ...
        assertTrue("should have loaded tables", parser.loadTables(new File("src/test/resources/parser/Simple2.cgt")));
    ...
    public void testLoadTables_File_EGT() throws Exception {
        TestParser parser = new TestParser();
        assertTrue("should have loaded tables", parser.loadTables(new File("src/test/resources/parser/Simple2.egt")));
        validateLoadTable(parser);
    }
    ...
    public void testLoadTables_InputStream() throws Exception {
        TestParser parser = new TestParser();
        InputStream is = new FileInputStream("src/test/resources/parser/Simple2.cgt");
    ...
    public void testParse_simple_with_nested_comments() throws Exception {
        ...
        TestParser parser = new TestParser();
        parser.setTrimReductions(true);
        assertTrue("should have loaded tables", parser.loadTables(new File("src/test/resources/parser/Simple2a.egt")));
        assertTrue("should have opened source to parse", parser.open(src));
